          ...
          <div style={{ width: "50%", flexShrink: 0, padding: "0 4px 0 8px" }}>
            ...
            <div style={{ fontSize: 12, color: C2, lineHeight: 1.7 }}>
              {rows.map(([label, val, icon], i) => (
                <div key={label} style={{ display: "flex", justifyContent: i < 2 ? "flex-start" : "space-between", alignItems: "center", gap: i < 2 ? 6 : 0, borderBottom: `1px dashed #c4a8e8`, paddingBottom: 1, marginBottom: 2 }}>
